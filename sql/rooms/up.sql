...
CREATE TABLE Rooms (
    ...
    "floor"              FloorTypeEnum NOT NULL,
    "seating"            SeatingTypeEnum NOT NULL,
    "microphone"         MicrophoneTypeEnum[] NOT NULL,
    "accessibility"      AccessibilityTypeEnum[] NOT NULL,
    "audiovisual"        AudiovisualTypeEnum[] NOT NULL,
    "infotechnology"     InfotechnologyTypeEnum[] NOT NULL,
    "writingMedia"       WritingMediaTypeEnum[] NOT NULL,
